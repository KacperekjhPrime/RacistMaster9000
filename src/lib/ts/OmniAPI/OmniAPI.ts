...
const OmniAPI = {
  ...
  async finishRideEntry(tournamentId: IdType, rideId: IdType, entryId: IdType, time: number, fetch = window.fetch) {
  ...
  async addTimePenalty(tournamentId: IdType, rideId: IdType, entryId: IdType, penaltyTime: number, fetch = window.fetch) {
    return await patchAPI(fetch, '/api/tournaments/[id]/rides/[rideId]/entries/[entryId]', {
      id: tournamentId.toString(),
      rideId: rideId.toString(),
      entryId: entryId.toString()
    }, {
